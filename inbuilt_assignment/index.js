...
fs.writeFileSync("nodejsarchitecture.txt",data);
...
fs.appendFileSync("nodejsarchitecture.txt",newdata);

let readata=fs.readFileSync("nodejsarchitecture.txt");
console.log(readata.toString());

fs.unlink("nodejsarchitecture.txt",()=>{
